...
- Name: booking.spec.ts >> Skip Booking System - E2E Tests >> TC004: BS1 4DJ - Error on first call, success on retry
- Location: automation\tests\booking.spec.ts:118:7
...
Expected substring: "SW1A 1AA"
Received string:    "BS1 4DJ"
```
  ...
  - generic [ref=e17]:
    ...
    - generic [ref=e32]:
      ...
      - generic [ref=e36]:
        ...
        - generic [ref=e38]: £48.00
      - generic [ref=e39]:
        - generic [ref=e40]: "Total:"
        - generic [ref=e41]: £288.00
    - generic [ref=e42]:
